...
<div class="relative inline-block" use:clickOutside={() => isOpen = false}>
    <button
        ...
        class="w-12 h-12 bg-slate-50 text-slate-400 hover:bg-slate-900 hover:text-white rounded-2xl transition-all flex items-center justify-center cursor-pointer"
    ...
    {#if isOpen}
        ...
        >
            ...
            <button
                ...
                class="w-full flex items-center gap-3 p-3 rounded-xl text-xs font-bold hover:bg-slate-50 transition-colors cursor-pointer"
            >
            ...
            <button
                ...
                class="w-full flex items-center gap-3 p-3 rounded-xl text-xs font-bold text-rose-600 hover:bg-rose-50 transition-colors cursor-pointer"
            >
